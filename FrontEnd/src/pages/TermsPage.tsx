  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <section className="container py-16 max-w-3xl prose prose-sm dark:prose-invert flex-1">
        ...
        <p className="text-muted-foreground">By using InstantAid Pay, you agree to these terms. This is a demo platform for educational and demonstration purposes.</p>
        ...
        <p className="text-muted-foreground">InstantAid Pay is provided "as is" without warranties. We are not liable for any losses incurred during demo use.</p>
        <h2 className="text-foreground">5. Contact</h2>
        <p className="text-muted-foreground">For questions, reach out at support@instantaidpay.co.ke</p>
      </section>
      <PublicFooter />
    </div>
  );
